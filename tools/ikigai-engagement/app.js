/**
 * 🎯 Ikigai Engagement - Application principale
 * BastaVerse - Découverte interactive de son Ikigai Engagement
 */
...
class IkigaiApp {
    constructor() {
        ...
        this.circles = [
            { name: "MOI", color: "#ff9aa2", cx: 430, cy: 160, r: 150, emoji: "❤️" },
            { name: "L'ENTREPRISE", color: "#87ceeb", cx: 300, cy: 360, r: 150, emoji: "🤌" },
            { name: "L'EQUIPE", color: "#90ee90", cx: 540, cy: 360, r: 150, emoji: "🧢" },
        ];

        this.wizard = null;
        this.isDragging = false;
        this.storageKey = 'ikigai-engagement-explorer-data';
    ...
    makeLeverDraggable(leverElement, index) {
        ...
        const drag = (clientX, clientY) => {
            ...
            draggedElement.style.left = (clientX - 75) + 'px'; // 75px = moitié largeur levier
            draggedElement.style.top = (clientY - 40) + 'px';  // 40px = moitié hauteur levier
    ...
    showSummary() {
        ...
        const emojiText = `
    🎯 **MON IKIGAI D'ENGAGEMENT - ${new Date().toLocaleDateString()}**
